...
(function() {
    ...
    app.directive('uiMap', ['uiMapConfig', '$parse', function(uiMapConfig, $parse) {
    ...
    app.directive('uiMapInfoWindow', ['uiMapInfoWindowConfig', '$parse', '$compile', function(uiMapInfoWindowConfig, $parse, $compile) {
